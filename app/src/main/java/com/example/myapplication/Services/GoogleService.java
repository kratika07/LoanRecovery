...
import com.example.myapplication.ModuleAgents.Activity.StartAgentActivity;
...
public class GoogleService extends Service implements LocationListener {
  ...
  //  double lattitude,longitude;
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        Intent notificationIntent = new Intent(this, StartAgentActivity.class);
            ...
            mHandler.post(new Runnable() {
                ...
                public void run() {
                  //  Toast.makeText(GoogleService.this, "hello", Toast.LENGTH_SHORT).show();
                   Toast.makeText(GoogleService.this, "Lattitude Longitude"+latitude+" "+ longitude, Toast.LENGTH_SHORT).show();
                }
            });
        }
