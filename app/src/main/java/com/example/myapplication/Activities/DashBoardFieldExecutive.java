...
public class DashBoardFieldExecutive extends AppCompatActivity {
    ...
    void mFunNewTask() {
       /* Intent intent=new Intent(DashBoardFieldExecutive.this, NewTaskActivty.class);
        startActivity(intent);*/
    }

    @OnClick(R.id.mLayoutVipNumber)
    void mFunVipNumber() {
        startActivity(new Intent(DashBoardFieldExecutive.this, VipNumberActivity.class));
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dash_board_field_executive);
        ButterKnife.bind(this);
        checkPermission();
        Glide.with(DashBoardFieldExecutive.this)
                .load(PreferenceManager.getLOANUSERIMAGE(DashBoardFieldExecutive.this))
                .apply(RequestOptions.circleCropTransform().placeholder(R.mipmap.ic_launcher_round).error(R.mipmap.ic_launcher_round))
                .into(mUserImg);

        if (CommonMethods.isOnline(DashBoardFieldExecutive.this))
        {
            show(DashBoardFieldExecutive.this);
            mFunUserTaskCount();
        }
        else if (!CommonMethods.isOnline(DashBoardFieldExecutive.this))
        {
            mShowAlert("please check your internet connection", DashBoardFieldExecutive.this);
        }

        if(timeOfDay >= 0 && timeOfDay < 12){
            mTextRoleName.setText("Good Morning, " + PreferenceManager.getLOANUSERFIRSTNAME(DashBoardFieldExecutive.this));
        }else if(timeOfDay >= 12 && timeOfDay < 16){
            mTextRoleName.setText("Good Afternoon, " + PreferenceManager.getLOANUSERFIRSTNAME(DashBoardFieldExecutive.this));
        }else if(timeOfDay >= 16 && timeOfDay < 21){
            mTextRoleName.setText("Good Evening, " + PreferenceManager.getLOANUSERFIRSTNAME(DashBoardFieldExecutive.this));
        }else if(timeOfDay >= 21 && timeOfDay < 24){
            mTextRoleName.setText("Good Night, " + PreferenceManager.getLOANUSERFIRSTNAME(DashBoardFieldExecutive.this));
        }
    ...
    private boolean checkPermission() {
        ...
        for (String permis : perm) {
            int resultPhone = ContextCompat.checkSelfPermission(DashBoardFieldExecutive.this, permis);
    ...
    private boolean requestPermission(List<String> perm) {
        ...
        for (String permissions : listReq) {
            if (ActivityCompat.shouldShowRequestPermissionRationale(DashBoardFieldExecutive.this, permissions)) {
                Toast.makeText(getApplicationContext(), "Phone Permissions needed for " + permissions, Toast.LENGTH_LONG);
            }
        }

        ActivityCompat.requestPermissions(DashBoardFieldExecutive.this, listReq, 1);
    ...
    void mFunUserTaskCount() {
        StringRequest strRequest = new StringRequest(Request.Method.POST, CommonMethods.BASE_URL + "getExecutiveAssignmentCount",
                    ...
                    public void onResponse(String str) {
                        ...
                        try {
                            ...
                            if (mStrStatus.equals("1")) {
                                ...
                                CommonMethods.mShowAlert("Your session has expired, Please Login again", DashBoardFieldExecutive.this);
                                Handler handler = new Handler();
                                handler.postDelayed(new Runnable() {
                                    @Override
                                    public void run() {
                                        Intent intent = new Intent(DashBoardFieldExecutive.this, RoleSelectScreen.class);
                                        startActivity(intent);
                                        finish();
                                    }
                                }, 1000);
                            } else {
                                CommonMethods.mShowAlert("Something went wrong", DashBoardFieldExecutive.this);
                            }
            ...
            protected Map<String, String> getParams() {
                ...
                params.put("id", PreferenceManager.getLOANUSERID(DashBoardFieldExecutive.this));
                params.put("auth_token", PreferenceManager.getLOANTOKEN(DashBoardFieldExecutive.this));
                return params;
            }
        };
    ...
    private void logout() {
        mShowAlert("Logout Successfully", DashBoardFieldExecutive.this);
        PreferenceManager.setLOANISLOGIN(DashBoardFieldExecutive.this,"0");
        PreferenceManager.setLoanUserroleId(DashBoardFieldExecutive.this,"0");
        Handler handler = new Handler();
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
                startActivity(new Intent(DashBoardFieldExecutive.this, RoleSelectScreen.class));
                finish();
            }
        }, 1000);
